 ...
 * 
 */
public interface ILogLastFiles extends PersistentObject {
	 ...
	 */
	public abstract String getRecipientsMailAddress();

	public abstract String getSize();
	
	public abstract void setSize(String size) throws BusinesslogicException;
