...
public class Pattern {
	...
	/**
	 * Matches the expression with the text
	 * 
	 * @param text
	 * @param matches
	 */
	private native void _match(String text, List matches)/*-{
		var regExp = this.@org.openehealth.tewepo.twp.dmp.dmc.client.utils.Pattern::regExp;
	...
	/**
	 * Split the input String and the regular expression
	 * @param input
	 * @param results
	 */
