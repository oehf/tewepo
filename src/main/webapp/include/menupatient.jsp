		...
		<ul style="margin-top:20px">
			<li id="id_li_de_homepage" style="border-top:1px solid #F9B000">
				<a href="<%=request.getContextPath().toString()%>/Dispatcher?identity=homepage"
					title="Startseite" id="id_a_de_homepage">
					Startseite
				</a>
			</li>
			...
			<li id="id_li_de_dicomemailpage">
				<a href="<%=request.getContextPath().toString()%>/Dispatcher?identity=dicomemailpage"
					title="Dateien versenden" id="id_a_de_dicomemailpage">
					Dateien versenden
				</a>
			</li>
			...
			<li id="id_li_de_useradministrationpage">
				<a href="<%=request.getContextPath().toString()%>/Dispatcher?identity=showuserdatapage"
					title="Benutzerverwaltung" id="id_a_de_useradministrationpage">
					Benutzerverwaltung
				</a>
			</li>
			...
			<li id="id_li_de_contactpage">
				<a href="<%=request.getContextPath().toString()%>/Dispatcher?identity=contactpage"
					title="Kontakt" id="id_a_de_contactpage">
					Kontakt
				</a>
			</li>
			...
			<li id="id_li_de_legalnoticepage">
				<a href="<%=request.getContextPath().toString()%>/Dispatcher?identity=legalnoticepage"
					title="Impressum" id="id_a_de_legalnoticepage">
					Impressum
				</a>
			</li>
		</ul>
