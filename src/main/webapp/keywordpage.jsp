...
<html>
	<head>
		...
		<!--
			...
			#content a#horizontalmenuetable_a_keywordpagerequest{
				font-weight:bold;
			}
			 ...
			 %>
				...
				<div id="content">
					...
					<p>			
						...
						die Möglichkeit Ihren Benutzername und Passwort anzufordern.
						<br></br>
					</p>
					<br>
					...
					Anschließend bekommen Sie auf Ihre registrierte E-Mail Adresse ein
					generiertes Passwort zugesendet. Mit diesem Passwort k&ouml;nnen Sie sich wieder am
					Portal anmelden und das Passwort &auml;ndern.</strong> 
					<br></br>

					<form action="<%=path%>/Dispatcher" method="post" name="FormPasswortanfrage" id="FormPasswortanfrage"
						onsubmit="return pruefeLogin()"><input type="hidden" name="identity" value="passwordrequest">
						
						<table class="table">
							<tr>
								<td>
									<strong>Ihr Benutzername:</strong>&nbsp;
								</td>
								<td id="tableTdInput">
									<input type="text" name="username" id="username" value="" size="100" maxlength="100" style="width: 99%;">
								</td>
							</tr>		
							<tr>
								<td>
					...
					<div class="guideline">
						...
						E-Mail Adresse auf die Groß- und Kleinschreibung, da sonst die Passwort-Anfrage nicht bearbeiten
						werden kann.<br></br>
